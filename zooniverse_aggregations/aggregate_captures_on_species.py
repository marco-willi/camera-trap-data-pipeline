...
flags['QUESTION_MAIN'] = 'species'
flags['QUESTION_MAIN_EMPTY'] = 'blank'
flags['QUESTION_COUNTS'] = ['count']
flags['COUNTS_TO_ORDINAL_MAPPER'] = {'10-50': 11, '51+': 12, '': 0}
...
annotation_id_to_name_mapper = {v: k for k, v in row_name_to_id_mapper.items()}
    ...
    with open(args['subject_csv'], "r") as ins:
        ...
        for line_no, line in enumerate(csv_reader):
            ...
            if subject_id in subject_info:
                ...
                logger.debug("Subject {} has no classifications".format(subject_id))
...
def proportion_affirmative(question_stats):
    ...
    try:
        ...
        raise ValueError("Error trying to divide {} by {}".format(true, tot))
