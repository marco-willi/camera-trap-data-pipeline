...
#PBS -q small
#PBS -N eval_species
#PBS -o ${HOME}/job_ml_output_eval_species_${PBS_JOBID}.log
#PBS -e ${HOME}/job_ml_error_eval_species_${PBS_JOBID}.log

INPUT_PATH=/home/packerc/shared/machine_learning/data/info_files/SNAPSHOT_SAFARI/
INPUT_FILE=SNAPSHOT_SAFARI_data_species_test.csv


OUTPUT_ROOT=/home/packerc/shared/machine_learning/data/predictions/
OUTPUT_PATH=${OUTPUT_ROOT}species/PANTHERA_SNAPSHOT_SAFARI/Xception_v1/predictions.json
